...
contract TestToken is TokenERC20 {

    function TestToken() TokenERC20(2500000000, "TestToken", "Test", 18) public {
...
contract TestTokenVault is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public timeLockPeriod = 300 days;
    ...
    function TestTokenVault(ERC20 _token) public {
        owner = msg.sender;
